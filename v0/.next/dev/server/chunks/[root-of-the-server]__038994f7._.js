...
"[project]/lib/systemd.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function listServices(names) {
    ...
    const out = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exec$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["run"])("systemctl", [
        "show",
        ...names,
        "--no-page",
...
async function systemctlAction(service, verb) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exec$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["run"])("sudo", [
        "systemctl",
        verb,
        service
    ]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systemd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/systemd.ts [app-route] (ecmascript)");
;
;
async function GET() {
    const names = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systemd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllowedServices"])();
    const services = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systemd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listServices"])(names);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__038994f7._.js.map